...
const id = "hinisap253@astarmax.com";  //MyID
...
(async function(){
    ...
    //delay
    await tab.waitForTimeout(5000);           // +++++WHY??+++++
    ...
    for(let i=0 ; i<challenge.length ; i++){
        addChallenge(challenge[i] , browser , createChallengeLink );
...
async function addChallenge(challenge , browser , createChallengeLink ){
  ...
  let outputFromat  = challenge['Output Format'];
  ...
  await newTab.type('#output_format-container .CodeMirror textarea' , outputFromat  );
